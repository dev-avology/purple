            ...
            <div className="col-lg-3">
              <div className="site-logo">
                ...
                <div className="mobile_header_icon">
                  <Link to="/" className="mobile_serch_icon">
                    <img alt="" src="" />
                  </Link>
                  <h1 className="mobile-menu" onClick={(e) => { e.preventDefault(); setToggle('1')}}>
                    <span>
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="header_navigation">
                <div className={`navigation  ${toggle === '0' ? '' :  'opened' }`} id="mySidenav">
                  <PrimaryMenu  closeMenu={close}/>
                </div>
              </div>
            </div>
          </div>
