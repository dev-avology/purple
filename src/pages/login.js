                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-12">
                                            <div className="lost_password">
                                                ...
                                                <p><Link to="#">Lost Password?</Link></p>
                                            </div>
                                        </div>
                                        <div className="col-lg-12">
                                        ...
                                        <div className="col-lg-12">
                                            <div className="signup_form_text text-center">
                                                <p>This site is protected by reCAPTCHA and the Google <Link to="#">Privacy Policy</Link> and <Link to="#">Terms of Service</Link> apply.</p>
                                            </div>
                                        </div>
                                    </div>
