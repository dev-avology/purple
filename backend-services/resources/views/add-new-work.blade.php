@extends('layouts.frontend')
	...
	<div class="container-fluid">
		<div class="add_new_work_step_three" style="display: none;">
			...
			<div class="row custom-products-list">
			</div>
		</div>
	</div>
	...
	jQuery(document).ready(function(){
        ...
        $('.image').change(function(){
            ...
            reader.onload = (e) => { 
                ...
                var artist_image = e.target.result;
                ...
                $.ajax({
                    ...
                    // },
                    success: (response) => { 
                        $('.custom-products-list').html(response.html);
                        var product_count = response.product_count;
                        geenrateFrames(artist_image, response.product_count);
                    },
...
function geenrateFrames(artist_image, product_count) {
	...
	for (let i = 1; i <= product_count; i++) {
		...
		$yourDesigner.on('ready', function() { 
            ...
            productDesigner[i].addCustomImage(artist_image, design_title, {autoCenter: true, price: 20, draggable: true});
