        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ul class="list-group list-group-horizontal float-md-right mt-2">
              ...
              <li class="list-group-item">
                <a href="#" class="text-secondary">Create Discount</a>
              </li>
            </ul> 
          </div> 
        </div><!-- /.row -->
            ...
            <div class="card">
              <div class="card-header border-0">
                <form action="">
                  <div class="form-group">
                    <input type="text" class="form-control" placeholder="Search discount codes">
                  </div>
                </form>
              </div>
              <div class="card-body table-responsive p-0">
                  <table class="table table-valign-middle table-hover cursor-pointer">
                    ...
                    <tbody>
                      <tr onclick="window.location='discount.php';">
                        <td>DISCOUNT10</td>
